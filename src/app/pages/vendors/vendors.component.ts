...
export class VendorsComponent {
  ...
  categories: { name: string; icon: string }[] = [
    ...
    { name: 'Fashion', icon: 'bi-person-bounding-box' },
    { name: 'Electronics', icon: 'bi-phone' },
    { name: 'Health', icon: 'bi-heart-pulse' },
    { name: 'Services', icon: 'bi-tools' },
    { name: 'Beauty', icon: 'bi-heart' },
    { name: 'Books', icon: 'bi-journal-text' },
    { name: 'Grocery', icon: 'bi-basket' },
    { name: 'Drinks and Beverages', icon: 'bi-cup-straw' },
    { name: 'Second hand sellers', icon: 'bi-box-seam' },
    { name: 'Lifestyle', icon: 'bi-star' }
  ];
